...
## Project Structure
    ...
    ├── testapiautosetting_127283  # Django project configurations
...
1. Clone this repo and `cd testapiautosetting_127283`
...
2. Clone this repo and `cd testapiautosetting_127283`
